...
class snowflake_unpivot(MacroSpec):
    name: str = "snowflake_unpivot"
    projectName: str = "br_framework"
    category: str = "Custom"


    @dataclass(frozen=True)
    class snowflake_unpivotProperties(MacroProperties):
    ...
    def apply(self, props: snowflake_unpivotProperties) -> str:
    ...
    def loadProperties(self, properties: MacroProperties) -> PropertiesType:
        ...
        return snowflake_unpivot.snowflake_unpivotProperties(
